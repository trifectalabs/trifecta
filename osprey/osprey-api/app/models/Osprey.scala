 ...
 * apidoc:0.11.19 http://www.apidoc.me/trifectalabs/osprey/0.3.14/play_2_4_client
 */
...
package com.trifectalabs.osprey.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.19 http://www.apidoc.me/trifectalabs/osprey/0.3.14/play_2_4_client"
    val Version = "0.3.14"
    val VersionMajor = 0
  ...
  class Client(
    val baseUrl: String = "http://trifecta.io",
    ...
    logger.info(s"Initializing com.trifectalabs.osprey.v0.Client for url $baseUrl")
