...
function [best_plan, best_score, iter] = training_pso(user_fitness_data, user_traits, user_prefs, init, obj)
    %Initialization
    % Range has the following format for short (1-3), avg (4-6), and long (7-9):
        % [Distance_min Distance_max]
        % [Time_min Time_max]
        % [Elevation_min Elevation_max]
    range = [user_prefs(2,2)/60*15 user_prefs(2,3)/60*60;...
             user_prefs(2,2) user_prefs(2,3);...
             50 450;...
             
             user_prefs(3,2)/60*15 user_prefs(3,3)/60*55;...
             user_prefs(3,2) user_prefs(3,3);...
             250 999;...
             
             user_prefs(4,2)/60*15 user_prefs(4,3)/60*50;...
             user_prefs(4,2) user_prefs(4,3);...
             500 user_fitness_data(1)*1.25];
    ...
    par = [];
    for i = 1:popsize
        par = [par; reshape(init(user_fitness,user_traits,macro_varience),1,npar)];
    end
